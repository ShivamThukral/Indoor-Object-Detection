...
class SunrgbdDatasetConfig(object):
    def __init__(self):
        ...
        self.type2class={'bed':0, 'table':1, 'sofa':2, 'chair':3, 'toilet':4, 'desk':5, 'dresser':6, 'door':7, 'bookshelf':8, 'bathtub':9}
        ...
        self.type2onehotclass={'bed':0, 'table':1, 'sofa':2, 'chair':3, 'toilet':4, 'desk':5, 'dresser':6, 'door':7, 'bookshelf':8, 'bathtub':9}
        ...
        '''
        self.type_mean_size = {'bathtub': np.array([0.767272,1.398258,0.456630]),
